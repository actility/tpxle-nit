...
bodyDev1.meta.device = process.env.TEST__DEV_EUI.toLowerCase(); // NS Specific !!! "meta.device" field

const bodyMobileApp = JSON.parse(bodyExampleText);
bodyMobileApp.meta.device = process.env.TEST__DEV_EUI_MOBILE_APP.toLowerCase(); // NS Specific !!! "meta.device" field

const bodyRnd = JSON.parse(bodyExampleText);
bodyRnd.meta.device = process.env.TEST__DEV_EUI_RND.toLowerCase(); // NS Specific !!! "meta.device" field
