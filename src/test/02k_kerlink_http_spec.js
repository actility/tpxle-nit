...
const nsName = 'kerlink'; // NS Specific !!!
...
bodyEcoKcUl.endDevice.devEUI = process.env.TEST__ECODX_DEVEUI.toUpperCase(); // NS Specific !!! ".DevEUI_uplink.DevEUI" field

const bodyEcoDxUl = JSON.parse(bodyExampleText);
bodyEcoDxUl.endDevice.devEUI = process.env.TEST__ECODX_DEVEUI.toUpperCase(); // NS Specific !!! ".DevEUI_uplink.DevEUI" field

const bodyPrevKcUl = JSON.parse(bodyExampleText);
bodyPrevKcUl.endDevice.devEUI = process.env.TEST__PREVKC_DEVEUI.toUpperCase(); // NS Specific !!! ".DevEUI_uplink.DevEUI" field

const bodyPrevDxUl = JSON.parse(bodyExampleText);
bodyPrevDxUl.endDevice.devEUI = process.env.TEST__PREVDX_DEVEUI.toUpperCase(); // NS Specific !!! ".DevEUI_uplink.DevEUI" field
