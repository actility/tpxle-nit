...
bodyEcoKcUl.DevEUI = process.env.TEST__ECOKC_DEVEUI; // NS Specific !!! "DevEUI" field

const bodyEcoDxUl = JSON.parse(bodyExampleText);
bodyEcoDxUl.DevEUI = process.env.TEST__ECODX_DEVEUI; // NS Specific !!! "DevEUI" field

const bodyPrevKcUl = JSON.parse(bodyExampleText);
bodyPrevKcUl.DevEUI = process.env.TEST__PREVKC_DEVEUI; // NS Specific !!! "DevEUI" field

const bodyPrevDxUl = JSON.parse(bodyExampleText);
bodyPrevDxUl.DevEUI = process.env.TEST__PREVDX_DEVEUI; // NS Specific !!! "DevEUI" field
...
// *****************************
// DOWNLINK FOR PROXYMUS IS NOT SUPPORTED YET!!!
// *****************************
