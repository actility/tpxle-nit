...
bodyDev1.devEUI = Buffer.from(process.env.TEST__DEV_EUI, 'hex').toString('base64'); // NS Specific !!! "devEUI" field

const bodyMobileApp = JSON.parse(bodyExampleText);
bodyMobileApp.devEUI = Buffer.from(process.env.TEST__DEV_EUI_MOBILE_APP, 'hex').toString('base64'); // NS Specific !!! "devEUI" field

const bodyRnd = JSON.parse(bodyExampleText);
bodyRnd.devEUI = Buffer.from(process.env.TEST__DEV_EUI_RND, 'hex').toString('base64'); // NS Specific !!! "devEUI" field
