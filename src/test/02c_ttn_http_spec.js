...
bodyEcoKcUl.end_device_ids.dev_eui = process.env.TEST__ECOKC_DEVEUI; // NS Specific !!! "end_device_ids.dev_eui" field

const bodyEcoDxUl = JSON.parse(bodyExampleText);
bodyEcoDxUl.end_device_ids.dev_eui = process.env.TEST__ECODX_DEVEUI; // NS Specific !!! "end_device_ids.dev_eui" field

const bodyPrevKcUl = JSON.parse(bodyExampleText);
bodyPrevKcUl.end_device_ids.dev_eui = process.env.TEST__PREVKC_DEVEUI; // NS Specific !!! "end_device_ids.dev_eui" field

const bodyPrevDxUl = JSON.parse(bodyExampleText);
bodyPrevDxUl.end_device_ids.dev_eui = process.env.TEST__PREVDX_DEVEUI; // NS Specific !!! "end_device_ids.dev_eui" field
