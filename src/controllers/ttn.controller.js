...
export const uplink_from_ttn = async (req, res) => {

    /*** Check if request body is correct ***/
    const errMsg = 'UL: x-client-id, x-client-secret, x-downlink-push, x-downlink-replace, x-downlink-apikey in header and end_device_ids.dev_eui in body are mandatory!';
    let clientID, clientSecret, devEUI, downlinkPush, downlinkReplace, downlinkApikey;
    try {
    ...
    DownlinkDataModel.setDLData('ttn', devEUI, { 
        downlinkPush: downlinkPush, 
        downlinkReplace: downlinkReplace, 
...
export const downlink_to_ttn = async (req, res) => {
